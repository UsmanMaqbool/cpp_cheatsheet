# C++ CHEATSHEET
⭐️ If you like this C++ reference, give it a star on GitHub! ⭐️

<a href="https://github.com/UsmanMaqbool/cpp_cheatsheet"><img align="right" src="https://camo.githubusercontent.com/38ef81f8aca64bb9a64448d0d70f1308ef5341ab/68747470733a2f2f73332e616d617a6f6e6177732e636f6d2f6769746875622f726962626f6e732f666f726b6d655f72696768745f6461726b626c75655f3132313632312e706e67" alt="Fork me on GitHub" data-canonical-src="https://s3.amazonaws.com/github/ribbons/forkme_right_darkblue_121621.png"></a>

Sources: [Phillip M. Duxbury's C++ Cheatsheet](http://www.pa.msu.edu/~duxbury/courses/phy480/Cpp_refcard.pdf), [Morten Nobel-Jørgensen](https://github.com/mortennobel/cpp-cheatsheet), [ISOCPP.org C++11 Cheatsheet](https://isocpp.org/blog/2012/12/c11-a-cheat-sheet-alex-sinyakov) and [Leupi - C++2011](https://cheatography.com/5907/cs/1197/)

## Standard types and their range
...
uint16_t    //      0 to 65535
int32_t     //      -21474​83648 to 2147483647
uint32_t    //      0 to 4294967295
int64_t     //      -9.2 * 10 to 9.2 * 10
uint64_t    //      0 to 1.8 * 10
```
...
#include <LI​B> // Includes standard header file LIB, i.e. <stdio.h>
#include "​Hea​der.h" // Includes Header.h file

#define X some text         // Replace X with some text
#define PI 3.14159265359 // Defines Easy Macro
#define F(a,b) a+b          // Replace F(1,2) with 1+2
#define X \ some tex        // Multiline definition

#undef PI // Remove Definition

#ifdef PI // Checks for defini​tion, if true, code will be compiled
#else //Else part of the above if-sta​tement
...
shared_ptr<int> x;          // Empty shared_ptr to a integer on heap. Uses reference counting for cleaning up objects. The heap is the place in memory where your dynamically allocated objects live. It is both copyable and movable. (unique are only moveable)
...
/ //division
% //modulo
++var //increase before evaluation (faster)
var++ // increase after evaluation
condition? result : altern​ative; //short form of if-like structure
:: //Scope Operator
...
```cpp
& //Gets RAM adress of Variab​le(to save
into pointer)
* // Derefe​rences pointe​r(r​eturns it ́s content) or defines a variable to be a pointer
